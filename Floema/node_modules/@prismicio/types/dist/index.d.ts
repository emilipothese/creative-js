 ...
 */
declare type ImageField<ThumbnailNames extends string | null = null, State extends FieldState = FieldState> = ThumbnailNames extends string ? ImageFieldImage<State> & Record<Exclude<ThumbnailNames, keyof ImageFieldImage>, ImageFieldImage<State>> : ImageFieldImage<State>;
/**
 * Link Types
 */
